        ...
        <Stack
          ...
          <SimpleGrid
            ...
            mt="20px"
                >
          {
arraydata.map((el) => <Box >
    <Image src={el} alt="single items"/>
</Box>)
          ...
          <Stack gap={2} margin={"auto"} w={{ base: "80%", md: "45%" }}  >
            <Heading textAlign={"left"} color={"blue.500"}>{prodata.category}</Heading>
            <Text textAlign={"left"} >Introducing our comfortable and stylish shirt, perfect for any occasion.

Crafted from high-quality, breathable fabric, this shirt is designed for all-day wear. The classic fit provides a flattering silhouette, while the soft texture ensures maximum comfort.

.</Text>
            <Text textAlign={"left"} fontSize="25px" fontWeight={"bold"} > ₹ {prodata.price}</Text>
            ...
            <Box w={"80%"}>
              <Text textAlign={"left"}>This shirt is easy to care for and can be machine washed and tumble dried, making it ideal for busy individuals who don't have the time for hand-washing or dry-cleaning.</Text>
            </Box>
