...
export default function Dashboard(){
    ...
    return<Box  w={FILL_PARENT}>
        ...
        <Heading color={BLACK} m={8}>DASHBOARD</Heading>
        ...
        <Grid   gap={6} gridTemplateColumns={{base:R1,sm:R2,lg:R3}}>
            ...
            <StatsBox name={"Total Earnings $"} br={6} size={300} color={BLACK} image={"https://www.svgrepo.com/show/500409/money.svg"} classname={"lush"} bcolor={GREEN} count={37} />
